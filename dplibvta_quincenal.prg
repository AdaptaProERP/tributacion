...
PROCE MAIN(oLibCom,oBtnBrw,cWhereLib)
  ...
  cCodigo:=EJECUTAR("REPBDLIST","DPDOCCLI","DIA_ANO,DIA_MES,DIA_QUINCE,MIN(DIA_FECHA) AS DESDE,MAX(DIA_FECHA) AS HASTA,COUNT(*) AS CUANTOS",.F.,cWhere,cTitle,aTitle,cFind,cFilter,cSgdoVal,cOrderBy,oBtnBrw)
